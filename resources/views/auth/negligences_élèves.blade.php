...
@section('page_title')
{{ __('Absences et retards des élèves') }}
@endsection
                ...
                <tbody>
                    @foreach($élèves as $élève)
                        <tr>
                            ...
                            <td class="align-middle">{{ count($élève->negligences) }}</td>
                            <td>
                                <a href="{{ route('parents.get_negligences', ['id' => $élève->id]) }}" class="btn btn-secondary">{{ __('Voir') }}</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>

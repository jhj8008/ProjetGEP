...
<div class="container">
    <div class="row justify-content-center" id="list_posts">
        <div class="row float-left action-btns">
            <a href="{{ route('parents.form_ajouter_post') }}" class="btn btn-primary a-btn-slide-text">

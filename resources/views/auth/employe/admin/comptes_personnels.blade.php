...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="row float-left action-btns">
            <a href="{{ route('admins.form_ajouter_personnel') }}" class="btn btn-primary a-btn-slide-text">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group" role="group" aria-label="action_buttons">
                                    <a href="{{ route('admins.form_modifier_personnel', ['id' => $personnel->id]) }}" class="btn btn-outline-secondary">{{ __('Modifier') }}</a>
                                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="{{ '#delete'.$personnel->id }}" title="Supprimer">{{ __('Supprimer') }}</button>
                                </div>
                            </td>
                        </tr>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a href="{{ route('admins.supprimer_personnel', ['id' => $personnel->id]) }}" class="btn btn-primary">Oui, supprimer</a>

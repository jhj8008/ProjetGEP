    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('enseignants.modifier_negligence', ['classe_id' => $classe_id, 'élève_id' => $élève_id, 'id' => $negligence->id]) }}">
                        @csrf
                        <input type="hidden" name="negligence_id" value="{{ $negligence->id }}">

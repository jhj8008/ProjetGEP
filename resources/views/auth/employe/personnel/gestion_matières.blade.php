        ...
        <div class="container mb-3 mt-3">
            <div class="row float-left action-btns">
                <a href="{{ route('personnels.form_ajouter_matière') }}" class="btn btn-primary a-btn-slide-text">
                    ...
                    <span><strong>Ajouter une nouvelle matière</strong></span>            
                </a>
            </div>
                ...
                <tbody class="text-body">
                    @foreach($matières as $matière)
                        <tr>
                            ...
                            <td class="align-middle">{{ $matière->description }}</td>
                            ...
                            <td>
                                ...
                                <div class="btn-group" role="group" aria-label="action_buttons">
                                    <a href="{{ route('personnels.form_modifier_matière', ['id' => $matière->id]) }}" class="btn btn-outline-secondary">{{ __('Modifier') }}</a>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="{{ 'ScrollableTitleDelete'.$matière->id }}">Supprimer matière</h5>
                                    ...
                                    <div class="modal-footer">
                                        <a href="{{ route('personnels.supprimer_matière', ['id' => $matière->id]) }}" class="btn btn-primary">Oui, supprimer</a>

                ...
                <tbody class="text-body">
                    @foreach($enseignants as $enseignant)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('personnels.liste_classes_affecter', ['id' => $enseignant->id]) }}" class="btn btn-outline-secondary" title="Voir ce profile">{{ __('Voir') }}</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>

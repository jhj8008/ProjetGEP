...
<div class="container">
    ...
    <div class="row float-right action-btns">
        <a href="{{ route('personnels.form_modifier_fiche', ['id' => $f_p->id]) }}" class="btn btn-primary a-btn-slide-text">
            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
            <span><strong>Modifier</strong></span>            
        </a>
        <a href="{{ route('personnels.supprimer_fiche', ['id' => $f_p->id]) }}" class="btn btn-primary a-btn-slide-text">

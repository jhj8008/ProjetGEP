            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('espace_élève') }}">{{ __('Espace élève') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('actualités') }}">{{ __('Actualités') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('activités') }}">{{ __('Activités') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle username" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->nom_père }} <span class="caret"></span>
                                </a>
